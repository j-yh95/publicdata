...
<head>
	...
	#mapWrapper{z-index: 4; position:absolute; width: 30%;  bottom: 0%; border: 3px solid gray;}
	#map{z-index: 5; position:absolute; bottom: 0; border: 2px solid gray;}
</style>
</head>
...
<div class="map_wrap" z-index: 1;>
	...
	<div id="mapWrapper" style="position:fixed;height:45%;float:left"z-index: 4; position:absolute; >
		<div id="map" style="width:100%;height:100%" position:absolute; z-index: 5; ></div> <!-- 지도를 표시할 div 입니다 -->
	</div>
</div>
